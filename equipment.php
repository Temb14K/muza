...
<body>
    ...
    <section class="submit-section">
        <div class="submit-section__inner submit-section__inner_alt container">
            <h1 class="submit-section__title">Арендуйте оборудование</h1>
            <p class="submit-section__p">Вы можете оставить заявку для связи с нами и уточнить наличие
                какого либо инвентаря. Наши запасы постоянно пополняются новинками.</p>
            <? if (@$_SESSION['isAuthorized'] == true) {
